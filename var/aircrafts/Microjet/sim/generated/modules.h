/* This file has been generated from /home/djim/Documents/paparazzi/conf/airframes/examples/microjet.xml */
/* Please DO NOT EDIT */
...
#include "nav/nav_airspeed.h"
#include "digital_cam/servo_cam_ctrl.h"
#include "digital_cam/dc.h"
...
static inline void modules_periodic_task(void) {
  ...
  if (openlog_periodic_2Hz_openlog_status == MODULES_START) {
    openlog_periodic_2Hz_openlog_status = MODULES_RUN;
  }
  if (openlog_periodic_2Hz_openlog_status == MODULES_STOP) {
    openlog_periodic_2Hz_openlog_status = MODULES_IDLE;
  }
  ...
  if (digital_cam_servo_servo_cam_ctrl_periodic_status == MODULES_START) {
    digital_cam_servo_servo_cam_ctrl_periodic_status = MODULES_RUN;
  }
  if (digital_cam_servo_servo_cam_ctrl_periodic_status == MODULES_STOP) {
    digital_cam_servo_servo_cam_ctrl_periodic_status = MODULES_IDLE;
  }
