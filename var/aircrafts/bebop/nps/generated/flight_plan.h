/* This file has been generated by gen_flight_plan from /home/djim/Documents/paparazzi/conf/flight_plans/rotorcraft_basic.xml */
/* Please DO NOT EDIT */
...
static inline void auto_nav(void) {
  switch (nav_block) {
    ...
    if ((nav_block != 14) && !(nav_is_in_flight())) { GotoBlock(14); return; }
    switch(nav_stage) {
      Stage(0)
